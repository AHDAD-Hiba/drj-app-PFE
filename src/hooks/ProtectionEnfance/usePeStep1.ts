...
export function usePeDemographie(rapportId: string | null) {
...
export function usePeEducation(rapportId: string | null) {
...
export function usePeAteliers(rapportId: string | null) {
...
export function usePeFormation(rapportId: string | null) {
