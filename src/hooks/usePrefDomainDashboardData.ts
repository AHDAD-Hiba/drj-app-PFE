    ...
    try {
      ...
      switch (requestDomain) {
        case "INFRA":
          ...
          break;
        case "FEMME":
          data = await loadAffairesFemininesDashboard(
            directionId,
            requestYear,
            selectedDomainId,
            lang,
        ...
        case PROTECTION_ENFANCE_DOMAIN_CODE:
          data = await loadProtectionEnfanceDashboard(
            directionId,
            requestYear,
            selectedDomainId,
            lang,
        ...
        case ENFANCE_CRECHES_DOMAIN_CODE:
          data = await loadEnfanceCrechesDashboard(
            directionId,
            requestYear,
            selectedDomainId,
            lang,
    ...
    switch (domain) {
      case "INFRA":
        channel
          .on(
            "postgres_changes",
            { event: "*", schema: "public", table: "infra_depenses" },
            loadDashboardData,
          )
          .on(
            "postgres_changes",
          ...
          .on(
            "postgres_changes",
            { event: "*", schema: "public", table: "infra_projets_btp" },
            loadDashboardData,
          )
          .on(
            "postgres_changes",
      ...
      case "FEMME":
        channel
          .on(
            "postgres_changes",
            { event: "*", schema: "public", table: "af_inscriptions_clubs" },
            loadDashboardData,
          )
          .on(
            "postgres_changes",
            { event: "*", schema: "public", table: "af_inscriptions_ofppt" },
            loadDashboardData,
          )
          .on(
            "postgres_changes",
          ...
          .on(
            "postgres_changes",
            { event: "*", schema: "public", table: "af_portes_ouvertes" },
            loadDashboardData,
          )
          .on(
            "postgres_changes",
            { event: "*", schema: "public", table: "af_formation_cadres" },
            loadDashboardData,
          )
          .on(
            "postgres_changes",
            { event: "*", schema: "public", table: "af_mise_a_jour_reseau" },
            loadDashboardData,
          )
          .on(
            "postgres_changes",
          ...
          .on(
            "postgres_changes",
            { event: "*", schema: "public", table: "af_centres_ecoute" },
            loadDashboardData,
          )
          .on(
            "postgres_changes",
            { event: "*", schema: "public", table: "af_suivi_partenariats" },
            loadDashboardData,
          )
          .on(
            "postgres_changes",
      ...
      case PROTECTION_ENFANCE_DOMAIN_CODE:
        channel
          ...
          .on(
            "postgres_changes",
            { event: "*", schema: "public", table: "pe_education" },
            loadDashboardData,
          )
          .on(
            "postgres_changes",
          ...
          .on(
            "postgres_changes",
            { event: "*", schema: "public", table: "pe_activites" },
            loadDashboardData,
          )
          .on(
            "postgres_changes",
      ...
      case ENFANCE_CRECHES_DOMAIN_CODE:
        channel
          .on(
            "postgres_changes",
            { event: "*", schema: "public", table: "cr_statistiques_enfants" },
            loadDashboardData,
          )
          .on(
            "postgres_changes",
            { event: "*", schema: "public", table: "cr_demandes_licences" },
            loadDashboardData,
          )
          .on(
            "postgres_changes",
            { event: "*", schema: "public", table: "cr_mouvements_fermetures" },
            loadDashboardData,
          )
          .on(
            "postgres_changes",
      ...
      default:
        channel
          .on(
            "postgres_changes",
            { event: "*", schema: "public", table: "activites" },
            loadDashboardData,
          )
          .on(
            "postgres_changes",
          ...
          .on(
            "postgres_changes",
            { event: "*", schema: "public", table: "suivi_remplissage" },
            loadDashboardData,
          )
          .on(
            "postgres_changes",
          ...
          .on(
            "postgres_changes",
            { event: "*", schema: "public", table: "encadrements" },
            loadDashboardData,
          )
          .on(
            "postgres_changes",
          ...
          .on(
            "postgres_changes",
            { event: "*", schema: "public", table: "partenariats" },
            loadDashboardData,
          )
          .on(
            "postgres_changes",
          ...
          .on(
            "postgres_changes",
            { event: "*", schema: "public", table: "stats_insertion" },
            loadDashboardData,
          )
          .on(
            "postgres_changes",
          ...
          .on(
            "postgres_changes",
            { event: "*", schema: "public", table: "etablissements" },
            loadDashboardData,
          )
          .on(
            "postgres_changes",
            { event: "*", schema: "public", table: "fermetures" },
            loadDashboardData,
          )
          .on(
            "postgres_changes",
            { event: "*", schema: "public", table: "suivi_projets" },
            loadDashboardData,
          );
        break;
    }
