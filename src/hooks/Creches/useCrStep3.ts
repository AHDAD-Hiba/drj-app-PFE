...
export function useCrStatistiquesEnfants(rapportId: string | null) {
...
export function useCrActivitesEnfants(rapportId: string | null) {
...
export function useCrFormationsCadres(rapportId: string | null) {
