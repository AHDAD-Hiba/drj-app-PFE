          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-bold">
                {isAr ? "تتبع الشراكات" : "Suivi des partenariats"}
              </h2>
              <p className="text-sm text-muted-foreground">
                {isAr
                  ? "حصيلة وتقييم اتفاقيات الشراكة"
                  : "Bilan et évaluation des conventions de partenariat"}
              </p>
            </div>
          </div>
          <Button
              ...
              >
                ...
                <div className="flex items-center justify-between gap-2 mb-1">
                  ...
                  <Button
                    ...
                    variant="ghost"
                    onClick={() => {
                      partenariats.remove(item.local_id);
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1.5">
                    <Label className="text-xs font-semibold">
                      {isAr ? "الشركاء المعنيون" : "Partenaires concernés"}
                    </Label>
                    <SafeInput
                  ...
                  <div className="space-y-1.5 sm:col-span-2">
                    ...
                    <SafeTextarea
                      placeholder={
                        isAr ? "مثال: جيد، في طور الإنجاز..." : "Ex: Positif, en cours..."
                      }
                  ...
                  <div className="space-y-1.5">
                    <Label className="text-xs font-semibold">
                      {isAr ? "المعيقات" : "Obstacles"}
                    </Label>
                    <SafeTextarea
                      placeholder={
                        isAr ? "مثال: تأخر في التمويل..." : "Ex: Retard de financement..."
                      }
                  ...
                  <div className="space-y-1.5">
                    ...
                    <SafeTextarea
                      placeholder={
                        isAr ? "مثال: تمديد فترة المشروع..." : "Ex: Prolongation du délai..."
                      }
