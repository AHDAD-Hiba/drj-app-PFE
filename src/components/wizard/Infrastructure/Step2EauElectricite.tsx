...
export const Step2EauElectricite = memo(
  ({ disabled, onActivity, rapportId }: StepComponentProps & { rapportId?: string | null }) => {
    ...
    const {
      ...
      update: updateEntry,
      loading,
    } = useInfraEauElectricite(rapportId || null);
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  {isAr
                    ? "تتبع متأخرات وتكاليف الاستهلاك حسب المؤسسة"
                    : "Suivi des arriérés et coûts de consommation par établissement"}
                </p>
              </div>
            </div>
            <Button
              ...
              size="sm"
              onClick={handleAdd}
              disabled={disabled || loading || loadingEtab}
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-1.5">
                        ...
                        <Select
                          ...
                          disabled={disabled}
                          onValueChange={(v) =>
                            handleUpdate(item.local_id, { type_filtre: v, etablissement_id: "" })
                          }
                        >
                      ...
                      <div className="space-y-1.5">
                        ...
                        <Select
                          ...
                          onValueChange={(v) =>
                            handleUpdate(item.local_id, { etablissement_id: v })
                          }
                        >
                          <SelectTrigger className="h-10 bg-background">
                            <SelectValue
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 border-t border-border/50 pt-4">
                      ...
                      <div className="space-y-1.5">
                        <NumericField
                          ...
                          onChange={(val) =>
                            handleUpdate(item.local_id, { arrieres_electricite: val })
                          }
                          disabled={disabled}
                        />
                      </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 border-t border-border/50 pt-4">
                      ...
                      <div className="space-y-1.5">
                        <NumericField
                          label={
                            isAr ? "كلفة استهلاك الكهرباء (درهم)" : "Consommation Électricité (DH)"
                          }
                          value={item.consommation_electricite || 0}
                          onChange={(val) =>
                            handleUpdate(item.local_id, { consommation_electricite: val })
                          }
                          disabled={disabled}
                        />
                      </div>
