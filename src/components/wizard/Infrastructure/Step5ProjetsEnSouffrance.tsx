...
export const Step5ProjetsEnSouffrance = memo(
  ({ disabled, onActivity, rapportId }: StepComponentProps & { rapportId?: string | null }) => {
    ...
    const {
      ...
      update: updateEntry,
      loading,
    } = useInfraProjetsSouffrance(rapportId || null);
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                {isAr
                  ? "تتبع المشاريع المتوقفة وتحديد أسباب التعثر والحلول"
                  : "Suivi des projets bloqués, causes et solutions proposées"}
              </p>
            </div>
          </div>
          <Button
                ...
                >
                  ...
                  <div className="flex items-center justify-between gap-2 border-b border-border/40 pb-3">
                    ...
                    <Button
                      ...
                      size="icon"
                      variant="ghost"
                      onClick={() => removeProjet(proj.local_id)}
                      disabled={disabled}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 border-t border-border/40 pt-4">
                    <div className="space-y-1.5">
                      ...
                      <SafeInput
                        ...
                        onValueChange={(val) =>
                          updateProjet(proj.local_id, { causes_blocage: val })
                        }
                        disabled={disabled}
                    ...
                    <div className="space-y-1.5">
                      ...
                      <SafeInput
                        ...
                        onValueChange={(val) =>
                          updateProjet(proj.local_id, { solutions_proposees: val })
                        }
                        disabled={disabled}
                        className="h-9 bg-background"
                      />
