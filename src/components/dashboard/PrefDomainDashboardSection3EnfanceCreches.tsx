      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
        <Card className="p-5 flex flex-col">
          <div className="mb-4">
            <h3 className="text-sm font-bold text-foreground">
              {t(
                "prefDomainDashboard.enfanceCreches.section3.demandesTypeTitle",
                "Demandes de licences par type",
              )}
            </h3>
            <p className="text-xs text-muted-foreground mt-0.5">
              {t(
                "prefDomainDashboard.enfanceCreches.section3.demandesTypeSubtitle",
            ...
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                <XAxis
                  type="number"
                  allowDecimals={false}
                  tickFormatter={(value: number) => fmtNum(value, lang)}
                />
                <YAxis
                  type="category"
                  dataKey="name"
        ...
        <Card className="p-5 flex flex-col">
          <div className="mb-4">
            <h3 className="text-sm font-bold text-foreground">
              {t(
                "prefDomainDashboard.enfanceCreches.section3.demandesStatutTitle",
                "Demandes de licences par statut",
              )}
            </h3>
            <p className="text-xs text-muted-foreground mt-0.5">
              {t(
                "prefDomainDashboard.enfanceCreches.section3.demandesStatutSubtitle",
        ...
        <Card className="p-5 flex flex-col lg:col-span-2">
          <div className="mb-4">
            <h3 className="text-sm font-bold text-foreground">
              {t(
                "prefDomainDashboard.enfanceCreches.section3.enfantsZoneTitle",
                "Enfants pris en charge : Garçons/Filles × Urbain/Rural",
              )}
            </h3>
            <p className="text-xs text-muted-foreground mt-0.5">
              {t(
                "prefDomainDashboard.enfanceCreches.section3.enfantsZoneSubtitle",
          ...
          <div className="h-[250px] w-full mt-auto">
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                <Bar
                  dataKey="Garcons"
                  name={t("prefDomainDashboard.enfanceCreches.section4.garcons", "Garçons")}
                  fill="#3b82f6"
                  radius={[4, 4, 0, 0]}
                />
                <Bar
                  dataKey="Filles"
                  name={t("prefDomainDashboard.enfanceCreches.section4.filles", "Filles")}
                  fill="#ec4899"
                  radius={[4, 4, 0, 0]}
                />
              </BarChart>
