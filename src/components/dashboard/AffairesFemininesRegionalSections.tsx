...
import { Ear, GraduationCap, HandCoins, Handshake, Percent, Users } from "lucide-react";
import {
  Area,
  AreaChart,
  CartesianGrid,
...
export function AffairesFemininesRegionalSections({
  data,
  locale,
}: AffairesFemininesRegionalSectionsProps) {
  ...
  return (
    <div className="space-y-8">
      ...
      <section className="w-full">
        <SectionTitle
          title={t("regDomainDashboard.femme.section.title", "Indicateurs Affaires Féminines")}
          subtitle={t(
        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 sm:gap-4 xl:grid-cols-6">
          <KpiCard
            ...
            value={kpis.totalInscriptionsFormation}
            locale={locale}
            icon={GraduationCap}
            accent="bg-primary"
          />
          <KpiCard
            label={t(
              "regDomainDashboard.femme.kpis.tauxIntegrationLaureates",
              "Taux d'intégration des lauréates",
            )}
            value={kpis.tauxIntegrationLaureates}
            locale={locale}
            icon={Percent}
            accent="bg-success"
            percentage
          ...
          <KpiCard
            label={t(
              "regDomainDashboard.femme.kpis.beneficiairesSensibilisation",
              "Bénéficiaires sensibilisation + portes ouvertes",
            )}
            value={kpis.totalBeneficiairesSensibilisationPortesOuvertes}
            locale={locale}
            icon={Users}
            accent="bg-info"
          />
          <KpiCard
            label={t("regDomainDashboard.femme.kpis.beneficiairesAgr", "Bénéficiaires AGR")}
            value={kpis.totalBeneficiairesAgr}
            locale={locale}
            icon={HandCoins}
            accent="bg-warning"
          />
          <KpiCard
            label={t("regDomainDashboard.femme.kpis.partenariatsSuivis", "Partenariats suivis")}
            value={kpis.totalPartenariatsSuivis}
            locale={locale}
            icon={Handshake}
            accent="bg-blue-600"
          />
          <KpiCard
            label={t("regDomainDashboard.femme.kpis.seancesEcoute", "Séances d'écoute")}
            value={kpis.totalSeancesCentresEcoute}
            locale={locale}
            icon={Ear}
            accent="bg-pink-600"
          />
      ...
      <section className="mt-8 w-full">
        <SectionTitle
          ...
          subtitle={t(
            "regDomainDashboard.femme.section3.subtitle",
            "Répartition régionale de la formation par secteur, toutes directions confondues",
          )}
        />
        <Card className="p-5 sm:p-6">
          <h3 className="font-bold text-foreground mb-1">
            {t(
              "regDomainDashboard.femme.charts.formationSecteurTitle",
              "Formation professionnelle par secteur",
            )}
          </h3>
          <p className="text-xs text-muted-foreground mb-4">
            {t(
              "regDomainDashboard.femme.charts.formationSecteurSubtitle",
              "Inscriptions OFPPT, agrégées par secteur pour l'ensemble de la région",
            )}
          </p>
              ...
              <PieChart margin={{ top: 15, right: 0, bottom: 0, left: 0 }}>
                ...
                <Legend
                  ...
                  formatter={(value: string) =>
                    t(`affairesFeminines.secteurs.${value}`, value) as string
                  }
                />
              </PieChart>
            </ResponsiveContainer>
      ...
      <section className="mt-8 w-full">
        <SectionTitle
          ...
          subtitle={t(
            "regDomainDashboard.femme.section4.subtitle",
            "Évolution trimestrielle de l'intégration des lauréates et de l'activité sociale",
          )}
        />
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card className="p-5 sm:p-6">
            <h3 className="font-bold text-foreground mb-1">
              {t(
                "regDomainDashboard.femme.charts.evolIntegrationTitle",
                "Évolution intégration des lauréates",
              )}
            </h3>
            <p className="text-xs text-muted-foreground mb-4">
              {t(
                "regDomainDashboard.femme.charts.evolIntegrationSubtitle",
                "Lauréates et intégrées par trimestre",
              )}
            </p>
            <div className="h-[280px]">
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart
                  data={evolutionIntegration}
                  margin={
                    isArabic
                ...
                >
                  ...
                  <Area
                    type="monotone"
                    dataKey="laureates"
                    name={t("regDomainDashboard.femme.legend.laureates", "Lauréates")}
                    stroke="#3b82f6"
                    fill="#3b82f6"
                    fillOpacity={0.2}
                    connectNulls={false}
                  ...
                  <Area
                    type="monotone"
                    dataKey="integrees"
                    name={t("regDomainDashboard.femme.legend.integrees", "Intégrées")}
                    stroke="#10b981"
                    fill="#10b981"
                    fillOpacity={0.2}
                    connectNulls={false}
          ...
          <Card className="p-5 sm:p-6">
            <h3 className="font-bold text-foreground mb-1">
              {t(
                "regDomainDashboard.femme.charts.evolActiviteSocialeTitle",
                "Évolution activité sociale",
              )}
            </h3>
            <p className="text-xs text-muted-foreground mb-4">
              {t(
                "regDomainDashboard.femme.charts.evolActiviteSocialeSubtitle",
                "Bénéficiaires AGR, séances d'écoute et partenariats",
              )}
            </p>
            <div className="h-[280px]">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart
                  data={evolutionActiviteSociale}
                  margin={
                    isArabic
                ...
                >
                  ...
                  <Line
                    ...
                    name={t("regDomainDashboard.femme.kpis.beneficiairesAgr", "Bénéficiaires AGR")}
                    stroke="#f59e0b"
                    strokeWidth={3}
                  ...
                  <Line
                    ...
                    name={t("regDomainDashboard.femme.kpis.seancesEcoute", "Séances d'écoute")}
                    stroke="#8b5cf6"
                    strokeWidth={3}
                    dot={{ strokeWidth: 2, r: 4 }}
                    activeDot={{ r: 6, strokeWidth: 0 }}
                  ...
                  <Line
                    ...
                    name={t(
                      "regDomainDashboard.femme.kpis.partenariatsSuivis",
                      "Partenariats suivis",
                    )}
                    stroke="#0ea5e9"
                    strokeWidth={3}
