    ...
    <section className="space-y-2">
      ...
      <div className="space-y-3">
        <Section6AccordionItem
          id="activites"
          title={t("prefDomainDashboard.details.activities.title", "Activités (Permanentes & Rayonnantes)") as string}
          icon={<Activity className="h-4 w-4 text-blue-500" />}
          isOpen={openSection === "activites"}
        ...
        <Section6AccordionItem
          id="camping"
          title={t("prefDomainDashboard.details.camping.title", "Programme National de Camping & Formations") as string}
        ...
        <Section6AccordionItem
          ...
          isOpen={openSection === "conventions"}
          onToggle={toggleSection}
        >
          {(() => {
        ...
        <Section6AccordionItem
          ...
          isOpen={openSection === "etablissements"}
          onToggle={toggleSection}
        >
          {(() => {
