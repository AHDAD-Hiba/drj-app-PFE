...
export const buildInfrastructureKpiItems = (
  ...
  console.log("🏗️ INFRA KPI CONFIG — kpis =", kpis);
  console.log("🏗️ budgetExecutionRate =", kpis?.budgetExecutionRate);
  console.log("🏗️ budgetEngagementRate =", kpis?.budgetEngagementRate);
 return [
    // 1. Taux d'exécution budgétaire (Σ crédits payés / Σ crédits ouverts)
  {
    ...
    format: "text",
    label: t("prefDomainDashboard.infrastructure.kpis.executionRate", "Taux d'exécution budgétaire"),
    color: {
  ...
  // 2. Taux d'engagement budgétaire (Σ crédits engagés / Σ crédits ouverts)
  {
    ...
    format: "text",
    label: t("prefDomainDashboard.infrastructure.kpis.engagementRate", "Taux d'engagement budgétaire"),
    color: {
  ...
  // 4. Nombre projets Partenariat
  {
    ...
    format: "number",
    label: t("prefDomainDashboard.infrastructure.kpis.projetsPartenariat", "Nombre projets Partenariat"),
    color: {
  ...
  // 5. Nombre projets en souffrance
  {
    ...
    format: "number",
    label: t("prefDomainDashboard.infrastructure.kpis.projetsEnSouffrance", "Nombre projets en souffrance"),
    color: {
