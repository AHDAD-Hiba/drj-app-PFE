...
export const buildEnfanceCrechesKpiItems = (
...
): KpiItem[] => [
  {
    ...
    format: "number",
    label: t(
      "prefDomainDashboard.enfanceCreches.kpis.enfantsPrisesEnCharge",
  ...
  },
  {
    ...
    format: "number",
    label: t(
      "prefDomainDashboard.enfanceCreches.kpis.demandesLicencesTraitees",
  ...
  },
  {
    ...
    format: "text",
    label: t(
      "prefDomainDashboard.enfanceCreches.kpis.delaiMoyenTraitement",
  ...
  },
  {
    ...
    format: "number",
    label: t(
      "prefDomainDashboard.enfanceCreches.kpis.crechesLabelliseesQualite",
      "Crèches labellisées qualité (obtenues)",
    ),
    color: {
  ...
  },
  {
    ...
    format: "number",
    label: t(
      "prefDomainDashboard.enfanceCreches.kpis.fermeturesCreches",
      "Fermetures de crèches signalées",
    ),
    color: {
