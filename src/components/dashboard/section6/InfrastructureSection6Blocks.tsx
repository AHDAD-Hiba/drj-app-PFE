...
export const buildInfrastructureSection6Blocks = (
  ...
  return [
          ...
          {[
            {
              key: "fonctionnement",
              label: t(
                "prefDomainDashboard.infrastructure.categories.fonctionnement",
                "Fonctionnement",
              ) as string,
            ...
            },
            {
              key: "investissement",
              label: t(
                "prefDomainDashboard.infrastructure.categories.investissement",
                "Investissement",
              ) as string,
              ...
              <div className="grid grid-cols-3 gap-3">
                <div className="p-3 bg-muted/30 rounded-xl border border-border/50 flex flex-col items-center justify-center text-center">
                  <span className="text-lg font-black text-foreground" dir="ltr">
                    {fmtDH(d.ouverts, lang)}
                  </span>
                  <span className="text-[10px] font-medium text-muted-foreground mt-1">
                    {
                      t(
                        "prefDomainDashboard.infrastructure.section6.depenses.ouverts",
                        "Ouverts",
                      ) as string
                    }
                  </span>
                ...
                <div className="p-3 bg-muted/30 rounded-xl border border-border/50 flex flex-col items-center justify-center text-center">
                  <span className="text-lg font-black text-foreground" dir="ltr">
                    {fmtDH(d.engages, lang)}
                  </span>
                  <span className="text-[10px] font-medium text-muted-foreground mt-1">
                    {
                      t(
                        "prefDomainDashboard.infrastructure.section6.depenses.engages",
                        "Engagés",
                      ) as string
                    }
                  </span>
                ...
                <div className="p-3 bg-emerald-500/10 rounded-xl border border-emerald-500/20 flex flex-col items-center justify-center text-center">
                  ...
                  <span className="text-[10px] font-medium text-emerald-600/80 mt-1">
                    {
                      t(
                        "prefDomainDashboard.infrastructure.section6.depenses.payes",
                        "Payés",
                      ) as string
                    }
                  </span>
    ...
    // 2. Eau & Électricité
    {
      id: "eauElectricite",
      title: t(
        "prefDomainDashboard.infrastructure.section6.eauElectricite.title",
        "Eau & Électricité",
      ) as string,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10">
          <div className="space-y-4">
            <h4 className="text-xs font-bold uppercase tracking-wider text-muted-foreground flex items-center gap-1.5">
              ...
              {
                t(
                  "prefDomainDashboard.infrastructure.section6.eauElectricite.consumption",
                  "Consommation",
                ) as string
              }
            </h4>
            <div className="grid grid-cols-2 gap-3">
              <div className="p-3 bg-sky-500/5 rounded-xl border border-sky-500/10 flex flex-col justify-center">
                <span className="text-sky-600 font-semibold text-xs flex items-center gap-1.5 mb-1">
                  ...
                  {
                    t(
                      "prefDomainDashboard.infrastructure.section6.eauElectricite.water",
                      "Eau",
                    ) as string
                  }
                </span>
                <span className="text-xl font-bold text-foreground" dir="ltr">
                  {fmtNum(data.eauElectricite.consommationEau, lang)}
                </span>
              </div>
              <div className="p-3 bg-amber-500/5 rounded-xl border border-amber-500/10 flex flex-col justify-center">
                <span className="text-amber-600 font-semibold text-xs flex items-center gap-1.5 mb-1">
                  ...
                  {
                    t(
                      "prefDomainDashboard.infrastructure.section6.eauElectricite.electricity",
                      "Électricité",
                    ) as string
                  }
                </span>
                <span className="text-xl font-bold text-foreground" dir="ltr">
                  {fmtNum(data.eauElectricite.consommationElectricite, lang)}
                </span>
              </div>
            </div>
          </div>
          <div className="space-y-4">
            <h4 className="text-xs font-bold uppercase tracking-wider text-muted-foreground flex items-center gap-1.5">
              ...
              {
                t(
                  "prefDomainDashboard.infrastructure.section6.eauElectricite.arrears",
                  "Arriérés",
                ) as string
              }
            </h4>
            <div className="grid grid-cols-2 gap-3">
              <div className="col-span-2 p-4 bg-red-500/10 rounded-xl border border-red-500/20 flex items-center justify-between">
                <span className="font-bold text-red-700 dark:text-red-400 text-sm">
                  {
                    t(
                      "prefDomainDashboard.infrastructure.section6.eauElectricite.totalArrears",
                      "Total Arriérés",
                    ) as string
                  }
                </span>
                <span className="text-2xl font-black text-red-600" dir="ltr">
                  {fmtDH(
                    data.eauElectricite.arrieresEau + data.eauElectricite.arrieresElectricite,
                    lang,
                  )}
                </span>
              </div>
              <div className="p-3 bg-muted/20 rounded-xl border border-border/50">
                ...
                <span className="text-lg font-bold text-foreground" dir="ltr">
                  {fmtDH(data.eauElectricite.arrieresEau, lang)}
                </span>
              </div>
              <div className="p-3 bg-muted/20 rounded-xl border border-border/50">
                <span className="text-[11px] font-medium text-muted-foreground block mb-1">
                ...
                <span className="text-lg font-bold text-foreground" dir="ltr">
                  {fmtDH(data.eauElectricite.arrieresElectricite, lang)}
                </span>
              </div>
            </div>
          </div>
    ...
    // 3. Partenariat
    {
      id: "partenariat",
      title: t(
        "prefDomainDashboard.infrastructure.section6.partenariat.title",
        "Partenariat",
      ) as string,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10">
          <div className="space-y-4">
            <h4 className="text-xs font-bold uppercase tracking-wider text-muted-foreground flex items-center gap-1.5">
              ...
              {
                t(
                  "prefDomainDashboard.infrastructure.section6.partenariat.summary",
                  "Bilan",
                ) as string
              }
            </h4>
            <div className="grid grid-cols-2 gap-3">
              <div className="col-span-2 p-4 bg-indigo-500/10 rounded-xl border border-indigo-500/20 flex items-center justify-between">
                <span className="font-bold text-indigo-700 dark:text-indigo-400 text-sm">
                  {
                    t(
                      "prefDomainDashboard.infrastructure.section6.partenariat.total",
                      "Total Projets",
                    ) as string
                  }
                </span>
              ...
              <div className="col-span-2 p-3 bg-muted/20 rounded-xl border border-border/50 flex items-center justify-between">
                <span className="text-xs font-medium text-muted-foreground">
                  {
                    t(
                      "prefDomainDashboard.infrastructure.section6.partenariat.avgProgress",
                      "Avancement moyen",
                    ) as string
                  }
                </span>
                <span className="text-lg font-bold text-foreground" dir="ltr">
                  {pct(data.partenariat.avancementMoyen)}
                </span>
              </div>
            </div>
          </div>
          <div className="space-y-4">
            <h4 className="text-xs font-bold uppercase tracking-wider text-muted-foreground flex items-center gap-1.5">
              ...
              {
                t(
                  "prefDomainDashboard.infrastructure.section6.partenariat.byPhase",
            ...
            <div className="p-4 bg-muted/30 rounded-xl border border-border/50 space-y-4">
              {data.partenariat.parPhase.length === 0 ? (
                <span className="text-sm text-muted-foreground">
                  {
                    t(
                      "prefDomainDashboard.infrastructure.section6.partenariat.noData",
                ...
                data.partenariat.parPhase.map(({ phase, count }) => {
                  const percentage =
                    data.partenariat.total > 0
                      ? Math.round((count / data.partenariat.total) * 100)
                      : 0;
                  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10">
          <div className="space-y-4">
            <h4 className="text-xs font-bold uppercase tracking-wider text-muted-foreground flex items-center gap-1.5">
              ...
              {
                t(
                  "prefDomainDashboard.infrastructure.section6.btp.breakdown",
                  "Répartition",
                ) as string
              }
            </h4>
            <div className="grid grid-cols-2 gap-3">
              <div className="p-3 bg-muted/30 rounded-xl border border-border/50 flex flex-col items-center justify-center text-center">
                <span className="text-2xl font-black text-foreground" dir="ltr">
                  {data.btp.construction}
                </span>
                <span className="text-[10px] font-medium text-muted-foreground mt-1">
                  {
                    t(
                      "prefDomainDashboard.infrastructure.categories.construction",
                      "Construction",
                    ) as string
                  }
                </span>
              ...
              <div className="p-3 bg-muted/30 rounded-xl border border-border/50 flex flex-col items-center justify-center text-center">
                <span className="text-2xl font-black text-foreground" dir="ltr">
                  {data.btp.amenagement}
                </span>
                <span className="text-[10px] font-medium text-muted-foreground mt-1">
                  {
                    t(
                      "prefDomainDashboard.infrastructure.categories.amenagement",
                      "Aménagement",
                    ) as string
                  }
                </span>
          ...
          <div className="space-y-4">
            <h4 className="text-xs font-bold uppercase tracking-wider text-muted-foreground flex items-center gap-1.5">
              ...
              {
                t(
                  "prefDomainDashboard.infrastructure.section6.btp.financials",
                  "Suivi financier",
                ) as string
              }
            </h4>
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="p-3 bg-emerald-500/5 rounded-xl border border-emerald-500/10">
                <span className="text-[11px] font-medium text-emerald-600/80 block mb-1">
                  {
                    t(
                      "prefDomainDashboard.infrastructure.section6.btp.paidAmount",
                      "Montant payé",
                    ) as string
                  }
                </span>
                <span className="text-lg font-bold text-emerald-600" dir="ltr">
                  {fmtDH(data.btp.montantPayeTotal, lang)}
                </span>
              </div>
              <div className="p-3 bg-blue-500/5 rounded-xl border border-blue-500/10">
                <span className="text-[11px] font-medium text-blue-600/80 block mb-1">
                  {
                    t(
                      "prefDomainDashboard.infrastructure.section6.btp.paymentRate",
                      "Taux paiement",
                    ) as string
                  }
                </span>
                <span className="text-lg font-bold text-blue-600" dir="ltr">
                  {pct(data.btp.tauxPaiement)}
                </span>
              </div>
              <div className="p-3 bg-amber-500/5 rounded-xl border border-amber-500/10">
                <span className="text-[11px] font-medium text-amber-600/80 block mb-1">
                  {
                    t(
                      "prefDomainDashboard.infrastructure.section6.btp.progress",
                      "Avancement",
                    ) as string
                  }
                </span>
                <span className="text-lg font-bold text-amber-600" dir="ltr">
                  {pct(data.btp.avancementMoyen)}
                </span>
              </div>
            </div>
          </div>
    ...
    // 5. Projets en souffrance
    {
      id: "enSouffrance",
      title: t(
        "prefDomainDashboard.infrastructure.section6.enSouffrance.title",
        ...
        <div className="space-y-4">
          <div className="p-4 bg-red-500/10 rounded-xl border border-red-500/20 flex items-center justify-between">
            <span className="font-bold text-red-700 dark:text-red-400 text-sm">
              {
                t(
                  "prefDomainDashboard.infrastructure.section6.enSouffrance.total",
                  "Total Projets Bloqués",
                ) as string
              }
            </span>
            <span className="text-3xl font-black text-red-600" dir="ltr">
              {data.enSouffrance.total}
            </span>
          </div>
          ...
          <div className="p-4 bg-muted/30 rounded-xl border border-border/50 space-y-4">
            {data.enSouffrance.causes.length === 0 ? (
              <span className="text-sm text-muted-foreground">
                {
                  t(
                    "prefDomainDashboard.infrastructure.section6.enSouffrance.noData",
                    "Aucun projet en souffrance signalé",
                  ) as string
                }
              </span>
            ) : (
              data.enSouffrance.causes.map(({ cause, count }) => {
                const percentage =
                  data.enSouffrance.total > 0
                    ? Math.round((count / data.enSouffrance.total) * 100)
                    : 0;
                return (
