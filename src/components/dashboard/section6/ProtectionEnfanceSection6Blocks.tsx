        ...
        <div className="space-y-6">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
            <div className="p-3 bg-blue-500/10 rounded-xl border border-blue-500/20 flex flex-col items-center justify-center text-center">
              ...
              <span className="text-[10px] font-medium text-muted-foreground mt-1">
                {
                  t(
                    "prefDomainDashboard.protectionEnfance.section6.priseEnCharge.total",
                    "Total",
                  ) as string
                }
              </span>
            ...
            <div className="p-3 bg-amber-500/10 rounded-xl border border-amber-500/20 flex flex-col items-center justify-center text-center">
              ...
              <span className="text-[10px] font-medium text-amber-600/80 mt-1">
                {
                  t(
                    "prefDomainDashboard.protectionEnfance.section6.priseEnCharge.migrants",
                    "Migrants",
                  ) as string
                }
              </span>
          ...
          <div className="p-3 bg-muted/20 rounded-xl border border-border/50 flex items-center justify-between">
            <span className="text-xs font-medium text-muted-foreground">
              {
                t(
                  "prefDomainDashboard.protectionEnfance.section6.priseEnCharge.changementMesure",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10">
          <div className="space-y-4">
            <h4 className="text-xs font-bold uppercase tracking-wider text-muted-foreground">
              {
                t(
                  "prefDomainDashboard.protectionEnfance.section6.educationFormation.education",
                  "Éducation",
                ) as string
              }
            </h4>
            <div className="grid grid-cols-2 gap-3">
              <div className="p-3 bg-muted/30 rounded-xl border border-border/50">
                <span className="text-[11px] font-medium text-muted-foreground block mb-1">
                  {
                    t(
                      "prefDomainDashboard.protectionEnfance.section6.educationFormation.educationFormal",
                      "Formel",
                    ) as string
                  }
                </span>
              ...
              <div className="p-3 bg-muted/30 rounded-xl border border-border/50">
                <span className="text-[11px] font-medium text-muted-foreground block mb-1">
                  {
                    t(
                      "prefDomainDashboard.protectionEnfance.section6.educationFormation.educationNonFormal",
                      "Non formel",
                    ) as string
                  }
                </span>
              ...
              <div className="p-3 bg-muted/30 rounded-xl border border-border/50">
                <span className="text-[11px] font-medium text-muted-foreground block mb-1">
                  {
                    t(
                      "prefDomainDashboard.protectionEnfance.section6.educationFormation.educationSoutien",
                      "Soutien",
                    ) as string
                  }
                </span>
              ...
              <div className="p-3 bg-emerald-500/10 rounded-xl border border-emerald-500/20 flex flex-col items-center justify-center text-center">
                ...
                <span className="text-[10px] font-medium text-emerald-600/80 mt-1">
                  {
                    t(
                      "prefDomainDashboard.protectionEnfance.section6.totalEducation",
                      "Total éducation",
                    ) as string
                  }
                </span>
          ...
          <div className="space-y-4">
            <h4 className="text-xs font-bold uppercase tracking-wider text-muted-foreground">
              {
                t(
                  "prefDomainDashboard.protectionEnfance.section6.educationFormation.formation",
                  "Formation",
                ) as string
              }
            </h4>
            <div className="grid grid-cols-2 gap-3">
              <div className="p-3 bg-muted/30 rounded-xl border border-border/50">
                <span className="text-[11px] font-medium text-muted-foreground block mb-1">
                  {
                    t(
                      "prefDomainDashboard.protectionEnfance.section6.educationFormation.intra",
                      "Intra-muros",
                    ) as string
                  }
                </span>
              ...
              <div className="p-3 bg-muted/30 rounded-xl border border-border/50">
                <span className="text-[11px] font-medium text-muted-foreground block mb-1">
                  {
                    t(
                      "prefDomainDashboard.protectionEnfance.section6.educationFormation.extra",
                      "Extra-muros",
                    ) as string
                  }
                </span>
              ...
              <div className="p-3 bg-muted/30 rounded-xl border border-border/50">
                <span className="text-[11px] font-medium text-muted-foreground block mb-1">
                  {
                    t(
                      "prefDomainDashboard.protectionEnfance.section6.educationFormation.initiation",
                      "Initiation",
                    ) as string
                  }
                </span>
              ...
              <div className="p-3 bg-emerald-500/10 rounded-xl border border-emerald-500/20 flex flex-col items-center justify-center text-center">
                ...
                <span className="text-[10px] font-medium text-emerald-600/80 mt-1">
                  {
                    t(
                      "prefDomainDashboard.protectionEnfance.section6.totalFormation",
                      "Total formation",
                    ) as string
                  }
                </span>
          ...
          {data.ateliersActivites.ateliers.length > 0 && (
            <div className="space-y-2">
              <h4 className="text-xs font-bold uppercase tracking-wider text-muted-foreground">
                {
                  t(
                    "prefDomainDashboard.protectionEnfance.section6.ateliersActivites.ateliers",
                    "Ateliers créés",
                  ) as string
                }
              </h4>
          ...
          {data.ateliersActivites.activitesParDomaine.length > 0 && (
            <div className="space-y-2">
              <h4 className="text-xs font-bold uppercase tracking-wider text-muted-foreground">
                {
                  t(
                    "prefDomainDashboard.protectionEnfance.section6.ateliersActivites.parDomaine",
              ...
              {data.ateliersActivites.activitesParDomaine.map((d) => (
                <div key={d.domaine} className="flex justify-between items-center text-xs">
                  ...
                  <span className="text-muted-foreground font-bold" dir="ltr">
                    {fmtNum(d.nombreBeneficiaires, lang)}
                  </span>
                </div>
              ))}
            </div>
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
            <div className="p-3 bg-muted/30 rounded-xl border border-border/50 flex flex-col items-center justify-center text-center">
              ...
              <span className="text-[10px] font-medium text-muted-foreground mt-1">
                {
                  t(
                    "prefDomainDashboard.protectionEnfance.section6.liberteSurveillee.scolaire",
                    "Scolaire",
                  ) as string
                }
              </span>
            ...
            <div className="p-3 bg-muted/30 rounded-xl border border-border/50 flex flex-col items-center justify-center text-center">
              ...
              <span className="text-[10px] font-medium text-muted-foreground mt-1">
                {
                  t(
                    "prefDomainDashboard.protectionEnfance.section6.liberteSurveillee.formationPro",
                    "Formation pro",
                  ) as string
                }
              </span>
            ...
            <div className="p-3 bg-muted/30 rounded-xl border border-border/50 flex flex-col items-center justify-center text-center">
              ...
              <span className="text-[10px] font-medium text-muted-foreground mt-1">
                {
                  t(
                    "prefDomainDashboard.protectionEnfance.section6.liberteSurveillee.stage",
                    "Stage",
                  ) as string
                }
              </span>
            ...
            <div className="p-3 bg-muted/30 rounded-xl border border-border/50 flex flex-col items-center justify-center text-center">
              ...
              <span className="text-[10px] font-medium text-muted-foreground mt-1">
                {
                  t(
                    "prefDomainDashboard.protectionEnfance.section6.liberteSurveillee.associations",
                    "Associations",
                  ) as string
                }
              </span>
          ...
          <div className="p-4 bg-cyan-500/10 rounded-xl border border-cyan-500/20 flex items-center justify-between">
            <span className="font-bold text-cyan-700 dark:text-cyan-400 text-sm">
              {
                t(
                  "prefDomainDashboard.protectionEnfance.section6.liberteSurveillee.total",
                  "Total intégrations",
                ) as string
              }
            </span>
      ...
      content: (
        <div className="p-4 bg-violet-500/10 rounded-xl border border-violet-500/20 flex items-center justify-between">
          <span className="font-bold text-violet-700 dark:text-violet-400 text-sm">
            {
              t(
                "prefDomainDashboard.protectionEnfance.section6.conseilEnfant.sessions",
                "Sessions organisées",
              ) as string
            }
          </span>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="p-3 bg-indigo-500/10 rounded-xl border border-indigo-500/20 flex flex-col items-center justify-center text-center">
              ...
              <span className="text-[10px] font-medium text-muted-foreground mt-1">
                {
                  t(
                    "prefDomainDashboard.protectionEnfance.section6.partenariats.conventions",
                    "Conventions",
                  ) as string
                }
              </span>
            ...
            <div className="p-3 bg-blue-500/10 rounded-xl border border-blue-500/20 flex flex-col items-center justify-center text-center">
              ...
              <span className="text-[10px] font-medium text-muted-foreground mt-1">
                {
                  t(
                    "prefDomainDashboard.protectionEnfance.section6.partenariats.projets",
                    "Projets exécutés",
                  ) as string
                }
              </span>
          ...
          {data.partenariats.partenaires.length > 0 && (
            <div className="space-y-2">
              <h4 className="text-xs font-bold uppercase tracking-wider text-muted-foreground">
                {
                  t(
                    "prefDomainDashboard.protectionEnfance.section6.partenariats.partenaires",
                    "Partenaires",
                  ) as string
                }
              </h4>
          ...
          {data.partenariats.sujets.length > 0 && (
            <div className="space-y-2">
              <h4 className="text-xs font-bold uppercase tracking-wider text-muted-foreground">
                {
                  t(
                    "prefDomainDashboard.protectionEnfance.section6.partenariats.sujets",
                    "Sujets",
                  ) as string
                }
              </h4>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="p-3 bg-teal-500/10 rounded-xl border border-teal-500/20 flex flex-col items-center justify-center text-center">
              ...
              <span className="text-[10px] font-medium text-muted-foreground mt-1">
                {
                  t(
                    "prefDomainDashboard.protectionEnfance.section6.formationPersonnel.sessions",
                    "Sessions",
                  ) as string
                }
              </span>
            ...
            <div className="p-3 bg-emerald-500/10 rounded-xl border border-emerald-500/20 flex flex-col items-center justify-center text-center">
              ...
              <span className="text-[10px] font-medium text-muted-foreground mt-1">
                {
                  t(
                    "prefDomainDashboard.protectionEnfance.section6.formationPersonnel.beneficiaires",
                    "Bénéficiaires",
                  ) as string
                }
              </span>
          ...
          {data.formationPersonnel.parCible.length > 0 && (
            <div className="space-y-2">
              <h4 className="text-xs font-bold uppercase tracking-wider text-muted-foreground">
                {
                  t(
                    "prefDomainDashboard.protectionEnfance.section6.formationPersonnel.parCible",
                    "Par cible",
                  ) as string
                }
              </h4>
        ...
        <div className="space-y-6">
          <div className="space-y-2">
            <h4 className="text-xs font-bold uppercase tracking-wider text-muted-foreground flex items-center gap-1.5">
              ...
              {
                t(
                  "prefDomainDashboard.protectionEnfance.section6.visitesDons.visites",
                  "Visites officielles",
                ) as string
              }
            </h4>
            {data.visitesDons.visites.length === 0 ? (
              <span className="text-sm text-muted-foreground">
                {
                  t(
                    "prefDomainDashboard.protectionEnfance.section6.visitesDons.noVisites",
                    "Aucune visite signalée",
                  ) as string
                }
              </span>
            ) : (
            ...
            <div className="p-3 bg-muted/20 rounded-xl border border-border/50 flex items-center justify-between">
              <span className="text-xs font-medium text-muted-foreground">
                {
                  t(
                    "prefDomainDashboard.protectionEnfance.section6.visitesDons.totalVisiteurs",
                    "Total visiteurs",
                  ) as string
                }
              </span>
          ...
          <div className="space-y-2">
            <h4 className="text-xs font-bold uppercase tracking-wider text-muted-foreground flex items-center gap-1.5">
              ...
              {
                t(
                  "prefDomainDashboard.protectionEnfance.section6.visitesDons.dons",
                  "Dons reçus",
                ) as string
              }
            </h4>
            {data.visitesDons.dons.length === 0 ? (
              <span className="text-sm text-muted-foreground">
                {
                  t(
                    "prefDomainDashboard.protectionEnfance.section6.visitesDons.noDons",
                    "Aucun don signalé",
                  ) as string
                }
              </span>
            ...
            <div className="p-3 bg-muted/20 rounded-xl border border-border/50 flex items-center justify-between">
              <span className="text-xs font-medium text-muted-foreground">
                {
                  t(
                    "prefDomainDashboard.protectionEnfance.section6.visitesDons.totalDons",
                    "Total dons",
                  ) as string
                }
              </span>
        ...
        <div className="grid grid-cols-3 gap-3">
          <div className="p-3 bg-muted/30 rounded-xl border border-border/50 flex flex-col items-center justify-center text-center">
            ...
            <span className="text-[10px] font-medium text-muted-foreground mt-1">
              {
                t(
                  "prefDomainDashboard.protectionEnfance.section6.amenagementEquipement.rehabilites",
                  "Réhabilités",
                ) as string
              }
            </span>
          ...
          <div className="p-3 bg-muted/30 rounded-xl border border-border/50 flex flex-col items-center justify-center text-center">
            ...
            <span className="text-[10px] font-medium text-muted-foreground mt-1">
              {
                t(
                  "prefDomainDashboard.protectionEnfance.section6.amenagementEquipement.equipes",
                  "Équipés",
                ) as string
              }
            </span>
          ...
          <div className="p-3 bg-slate-500/10 rounded-xl border border-slate-500/20 flex flex-col items-center justify-center text-center">
            ...
            <span className="text-[10px] font-medium text-muted-foreground mt-1">
              {
                t(
                  "prefDomainDashboard.protectionEnfance.section6.amenagementEquipement.total",
                  "Total",
                ) as string
              }
            </span>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="p-3 bg-red-500/10 rounded-xl border border-red-500/20 flex flex-col items-center justify-center text-center">
              ...
              <span className="text-[10px] font-medium text-muted-foreground mt-1">
                {
                  t(
                    "prefDomainDashboard.protectionEnfance.section6.incidentsRapports.totalIncidents",
                    "Incidents signalés",
                  ) as string
                }
              </span>
            ...
            <div className="p-3 bg-rose-500/10 rounded-xl border border-rose-500/20 flex flex-col items-center justify-center text-center">
              ...
              <span className="text-[10px] font-medium text-muted-foreground mt-1">
                {
                  t(
                    "prefDomainDashboard.protectionEnfance.section6.incidentsRapports.rapportsJudiciaires",
          ...
          {data.incidentsRapports.incidentsParType.length > 0 && (
            <div className="space-y-2">
              <h4 className="text-xs font-bold uppercase tracking-wider text-muted-foreground">
                {
                  t(
                    "prefDomainDashboard.protectionEnfance.section6.incidentsRapports.parType",
                    "Incidents par type",
                  ) as string
                }
              </h4>
