    ...
    <section className="space-y-4">
      <div>
        <h2 className="text-lg font-bold text-foreground">
          {t("prefDomainDashboard.enfanceCreches.section4.title", "Évolution trimestrielle")}
        </h2>
      </div>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
        <Card className="p-5">
          <div className="mb-4">
            <h3 className="text-sm font-bold text-foreground">
              {t(
                "prefDomainDashboard.enfanceCreches.section4.enfantsTitle",
                "Évolution des enfants pris en charge",
              )}
            </h3>
            <p className="text-xs text-muted-foreground mt-0.5">
              {t(
                "prefDomainDashboard.enfanceCreches.section4.enfantsSubtitle",
        ...
        <Card className="p-5">
          <div className="mb-4">
            <h3 className="text-sm font-bold text-foreground">
              {t(
                "prefDomainDashboard.enfanceCreches.section4.mouvementsTitle",
                "Évolution des mouvements",
              )}
            </h3>
            <p className="text-xs text-muted-foreground mt-0.5">
              {t(
                "prefDomainDashboard.enfanceCreches.section4.mouvementsSubtitle",
            ...
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                <Line
                  type="linear"
                  dataKey="Fermetures"
                  name={t("prefDomainDashboard.enfanceCreches.section4.fermetures", "Fermetures")}
                  stroke="#f59e0b"
                  strokeWidth={2}
                  connectNulls
                />
                <Line
                  ...
                  name={t(
                    "prefDomainDashboard.enfanceCreches.section4.reouvertures",
                    "Réouvertures",
                  )}
                  stroke="#10b981"
                  strokeWidth={2}
