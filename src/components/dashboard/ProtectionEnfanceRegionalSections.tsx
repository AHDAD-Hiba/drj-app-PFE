...
import { AlertTriangle, Globe2, GraduationCap, Percent, Shield, Users } from "lucide-react";
import {
  Area,
  AreaChart,
  CartesianGrid,
...
const translatePeCategory = (value: string, t: (key: string, fallback: string) => string) => {
  ...
  if (normalized === "éducation" || normalized === "education")
    return t("regDomainDashboard.pe.categories.education", "Éducation");
  if (normalized === "formation")
    return t("regDomainDashboard.pe.categories.formation", "Formation");
  return value;
};
...
export function ProtectionEnfanceRegionalSections({
  data,
  locale,
}: ProtectionEnfanceRegionalSectionsProps) {
  ...
  return (
    <div className="space-y-8">
      ...
      <section className="w-full">
        <SectionTitle
          title={t("regDomainDashboard.pe.section.title", "Indicateurs Protection de l'Enfance")}
          subtitle={t(
        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 sm:gap-4 xl:grid-cols-6">
          ...
          <KpiCard
            label={t(
              "regDomainDashboard.pe.kpis.tauxPreparationIntegration",
              "Taux de préparation à l'intégration",
            )}
            value={kpis.tauxPreparationIntegrationMoyen}
            locale={locale}
            icon={Percent}
            accent="bg-success"
            percentage
          ...
          <KpiCard
            label={t(
              "regDomainDashboard.pe.kpis.beneficiairesEducationFormation",
          ...
          />
          <KpiCard
            label={t("regDomainDashboard.pe.kpis.incidentsSignales", "Incidents exceptionnels")}
          ...
          <KpiCard
            label={t(
              "regDomainDashboard.pe.kpis.migrantsNonAccompagnes",
      ...
      <section className="mt-8 w-full">
        <SectionTitle
          ...
          subtitle={t(
            "regDomainDashboard.pe.section3.subtitle",
            "Répartition régionale Éducation/Formation et incidents exceptionnels, toutes directions confondues",
          )}
        />
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card className="p-5 sm:p-6">
            <h3 className="font-bold text-foreground mb-1">
              {t("regDomainDashboard.pe.charts.eduFormTitle", "Éducation vs Formation")}
            </h3>
            <p className="text-xs text-muted-foreground mb-4">
              {t(
                "regDomainDashboard.pe.charts.eduFormSubtitle",
                "Bénéficiaires régionaux, agrégés sur l'ensemble des directions",
              )}
            </p>
          ...
          <Card className="p-5 sm:p-6">
            <h3 className="font-bold text-foreground mb-1">
              {t(
                "regDomainDashboard.pe.charts.incidentsTypeTitle",
                "Incidents exceptionnels par type",
              )}
            </h3>
            <p className="text-xs text-muted-foreground mb-4">
              {t(
                "regDomainDashboard.pe.charts.incidentsTypeSubtitle",
                "Nombre de cas signalés, agrégés sur l'ensemble des directions",
              )}
            </p>
      ...
      <section className="mt-8 w-full">
        <SectionTitle
          ...
          subtitle={t(
            "regDomainDashboard.pe.section4.subtitle",
            "Évolution trimestrielle des bénéficiaires et des incidents exceptionnels",
          )}
        />
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card className="p-5 sm:p-6">
            <h3 className="font-bold text-foreground mb-1">
              {t("regDomainDashboard.pe.charts.evolGenreTitle", "Évolution garçons / filles")}
            </h3>
            <p className="text-xs text-muted-foreground mb-4">
              {t(
                "regDomainDashboard.pe.charts.evolGenreSubtitle",
                "Bénéficiaires en prise en charge par trimestre",
              )}
            </p>
          ...
          <Card className="p-5 sm:p-6">
            <h3 className="font-bold text-foreground mb-1">
              {t(
                "regDomainDashboard.pe.charts.evolIncidentsTitle",
                "Évolution des incidents exceptionnels",
              )}
            </h3>
            <p className="text-xs text-muted-foreground mb-4">
              {t(
                "regDomainDashboard.pe.charts.evolIncidentsSubtitle",
                "Nombre de cas signalés, par trimestre",
              )}
            </p>
            <div className="h-[280px]">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart
                  data={evolutionIncidents}
                  margin={
                    isArabic
                      ? { top: 10, right: 35, left: 40, bottom: 0 }
                      : { top: 10, right: 35, left: 20, bottom: 0 }
                ...
                >
                  ...
                  <Line
                    ...
                    dataKey="incidents"
                    name={t(
                      "regDomainDashboard.pe.kpis.incidentsSignales",
