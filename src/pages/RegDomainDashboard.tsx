...
import { RegionalDirectionPerformance } from "@/components/dashboard/RegionalDirectionPerformance";
import { RegionalDirectionsTable } from "@/components/dashboard/RegionalDirectionsTable";
...
const isJeunesseDashboard = (
  data: RegionalDashboardPayload,
): data is JeunesseRegionalDashboardData => "total_beneficiaires" in data.kpis;
const isInfrastructureDashboard = (
  data: RegionalDashboardPayload,
): data is InfrastructureRegionalDashboardData => "credits_ouverts" in data.kpis;
...
const RegDomainDashboard = () => {
  ...
  const {
    ...
    error,
    contentDomain,
  } = useRegionalDomainDashboardData(filterDomain, year, i18n.language);
  ...
  const jeunesseDashboard =
    dashboardData && isJeunesseDashboard(dashboardData) ? dashboardData : null;
  ...
  const infrastructureDashboard =
    dashboardData && isInfrastructureDashboard(dashboardData) ? dashboardData : null;
  ...
  const crechesDashboard =
    dashboardData && isCrechesDashboard(dashboardData) ? dashboardData : null;
    ...
    return (
      <AppLayout>
        <div className="flex min-h-[400px] items-center justify-center">
          <div
            className="flex max-w-md items-center gap-3 rounded-md border border-destructive/40 bg-destructive/5 p-5 text-destructive"
            role="alert"
          >
            <AlertCircle className="h-6 w-6 shrink-0" />
            <span>
              {t(
                "RegDomainDashboard.loadError",
                "Le chargement du tableau de bord a echoue. Veuillez reessayer.",
              )}
            </span>
          </div>
        </div>
  ...
  const rankedDirections = sortedDirections.map((d) => ({
    ...d,
    rang:
      isJeunesse || isInfrastructure || isFemme || isPE || isCreches
        ? d.rang_regional < 99
          ? d.rang_regional
          : null
        : null,
      ...
      <div className="space-y-6 animate-fade-in">
        ...
        <div className="relative overflow-hidden rounded-2xl gradient-hero p-6 sm:p-8 text-primary-foreground shadow-elegant">
          <div className="relative z-10 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
            ...
            <div className="flex flex-wrap items-center gap-2 flex-shrink-0"></div>
          </div>
        ...
        <div ref={dashboardRef} className="flex flex-col gap-6 w-full">
          ...
          {error && (
            <div
              className="flex items-center gap-3 rounded-md border border-destructive/40 bg-destructive/5 p-4 text-sm text-destructive"
              role="alert"
            >
          ...
          <RegionalCompletionTracking
            ...
            summaryText={t(
              "RegDomainDashboard.submittedCount",
              "{{n}} / {{total}} directions ont terminé",
              {
                n: completedCount,
              ...
              <section className="mt-8 w-full">
                <div className="mb-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    {t(
                      "RegDomainDashboard.section3.subtitle",
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div>
                      <h4 className="text-sm font-semibold text-center mb-2">
                        {t(
                          "RegDomainDashboard.section3.domainChartTitle",
                      ...
                      <ResponsiveContainer width="100%" height={220}>
                        <PieChart margin={{ top: 15, right: 0, bottom: 0, left: 0 }}>
                          <Pie
                            data={[
                              {
                                name: t("RegDomainDashboard.section3.domains.educatif", "Éducatif"),
                                value: jeunesseSection3.domaine_educatif,
                              },
                              {
                                name: t("RegDomainDashboard.section3.domains.culturel", "Culturel"),
                                value: jeunesseSection3.domaine_culturel,
                              },
                              {
                                name: t("RegDomainDashboard.section3.domains.sportif", "Sportif"),
                                value: jeunesseSection3.domaine_sportif,
                              },
                              {
                                name: t("RegDomainDashboard.section3.domains.capacite", "Capacité"),
                                value: jeunesseSection3.domaine_capacite,
                              },
                            ]}
                            dataKey="value"
                            cx="50%"
                      ...
                      <ResponsiveContainer width="100%" height={220}>
                        <PieChart margin={{ top: 15, right: 0, bottom: 0, left: 0 }}>
                          <Pie
                            data={[
                              {
                                name: t("RegDomainDashboard.section3.gender.femmes", "Femmes"),
                                value: jeunesseSection3.femmes,
                              },
                              {
                                name: t("RegDomainDashboard.section3.gender.hommes", "Hommes"),
                                value: jeunesseSection3.hommes,
                              },
                            ]}
                            dataKey="value"
                            cx="50%"
                    ...
                    <div>
                      <h4 className="text-sm font-semibold text-center mb-2">
                        {t(
                          "RegDomainDashboard.section3.territoryChartTitle",
                      ...
                      <ResponsiveContainer width="100%" height={220}>
                        <PieChart margin={{ top: 15, right: 0, bottom: 0, left: 0 }}>
                          <Pie
                            data={[
                              {
                                name: t("RegDomainDashboard.section3.territory.rural", "Rural"),
                                value: jeunesseSection3.rural,
                              },
                              {
                                name: t("RegDomainDashboard.section3.territory.urbain", "Urbain"),
                                value: jeunesseSection3.urbain,
                              },
                            ]}
                            dataKey="value"
                            cx="50%"
              ...
              <section className="mt-8 w-full">
                <div className="mb-4">
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    {t(
                      "RegDomainDashboard.section4.subtitle",
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <Card className="p-5 sm:p-6">
                    <h3 className="font-bold text-foreground mb-1">
                      {t(
                        "RegDomainDashboard.section4.activitiesTitle",
                        "Évolution Trimestrielle des Activités",
                      )}
                    </h3>
                    <p className="text-xs text-muted-foreground mb-4">
                      {t(
                        "RegDomainDashboard.section4.activitiesSubtitle",
                      ...
                      <ResponsiveContainer width="100%" height="100%">
                        ...
                        >
                          ...
                          <XAxis
                            ...
                            tickFormatter={(value) =>
                              t(
                                `RegDomainDashboard.quarters.${String(value).toLowerCase()}`,
                                String(value),
                              )
                            }
                          />
                          ...
                          <Tooltip
                            labelFormatter={(label) =>
                              t(
                                `RegDomainDashboard.quarters.${String(label).toLowerCase()}`,
                                String(label),
                              )
                            }
                          />
                  ...
                  <Card className="p-5 sm:p-6">
                    <h3 className="font-bold text-foreground mb-1">
                      {t(
                        "RegDomainDashboard.section4.establishmentsTitle",
                        "Évolution de l'État des Établissements",
                      )}
                    </h3>
                    <p className="text-xs text-muted-foreground mb-4">
                      {t(
                        "RegDomainDashboard.section4.establishmentsSubtitle",
                      ...
                      <ResponsiveContainer width="100%" height="100%">
                        ...
                        >
                          ...
                          <Line
                            ...
                            name={t(
                              "RegDomainDashboard.section4.status.fonctionnels",
                              "Fonctionnels",
                            )}
                            stroke="#10B981"
                            strokeWidth={3}
          ...
          {isInfrastructure && infrastructureDashboard && (
            <InfrastructureRegionalSections data={infrastructureDashboard} locale={i18n.language} />
          )}

          {isFemme && femmeDashboard && (
            <AffairesFemininesRegionalSections data={femmeDashboard} locale={i18n.language} />
          )}

          {isPE && peDashboard && (
            <ProtectionEnfanceRegionalSections data={peDashboard} locale={i18n.language} />
          )}

          {isCreches && crechesDashboard && (
            <EnfanceCrechesRegionalSections data={crechesDashboard} locale={i18n.language} />
          )}

          <RegionalDirectionPerformance
            title={t("RegDomainDashboard.section5.title", "Performance des Directions")}
            subtitle={t(
              "RegDomainDashboard.section5.subtitle",
          ...
          >
            <RegionalTopThree
              primary={{
                ...
                items: topMetricPrimary.map((item) => ({
                  id: item.id,
                  name: item.name,
                  value: item.metric_primary,
                })),
                  ...
                  : isFemme
                    ...
                    : isPE
                      ...
                      : isCreches
                        ...
                        : t(
                            "RegDomainDashboard.section5.topBeneficiaries",
                            "Top 3 par Bénéficiaires",
                          ),
                items: topMetricSecondary.map((item) => ({
                  id: item.id,
                  name: item.name,
                  value: item.metric_secondary,
                })),
                accentClassName: "text-success",
              }}
              formatValue={(value) =>
                `${formatNumber(value, i18n.language)}${isInfrastructure ? "%" : ""}`
              }
              renderItemName={(item) =>
            ...
            <RegionalDirectionsTable
              ...
              title={t(
                "RegDomainDashboard.section5.tableTitle",
                "Tableau Comparatif des Directions",
              )}
              subtitle={t(
                "RegDomainDashboard.section5.tableSubtitle",
                  ...
                  : isFemme
                    ...
                    : isPE
                      ...
                      : isCreches
                        ...
                        : t("RegDomainDashboard.section5.columns.metricPrimary", "Activités")
              }
                  ...
                  : isFemme
                    ...
                    : isPE
                      ...
                      : isCreches
                        ...
                        : t("RegDomainDashboard.section5.columns.metricSecondary", "Bénéficiaires")
              }
